...
public class LogStrippedSmoothDarkOak extends Wood implements BlockItemInterface {
	
	
	public final static String registry_name = "log_stripped_smooth_dark_oak";
	...
	public Item getBlockItem( Item.Properties properties ) {
		...
		return new BlockItem( ModBlocks.LOG_STRIPPED_SMOOTH_DARK_OAK, properties ).setRegistryName( registry_name );
	}
}